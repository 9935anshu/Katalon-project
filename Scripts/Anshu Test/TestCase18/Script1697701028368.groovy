...
WebUI.click(findTestObject('Object Repository/Page_Account Login/a_Forgotten Password'))

WebUI.setText(findTestObject('Object Repository/Page_Forgot Your Password/input_E-Mail Address_email'), 'anshu@binmile.com')

WebUI.click(findTestObject('Object Repository/Page_Forgot Your Password/button_Continue'))
