...
WebUI.click(findTestObject('Object Repository/Page_My Account/a_Change your password'))

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Change Password/input_Password_password'), 'TwW95KtKS4Q=')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Change Password/input_Password Confirm_confirm'), 'TwW95KtKS4Q=')

WebUI.click(findTestObject('Object Repository/Page_Change Password/a_Back'))
