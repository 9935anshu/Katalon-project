...
WebUI.click(findTestObject('Object Repository/Page_My Account/a_Edit cart'))

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart/input_Product 1_quantity31921'))

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart/i_Product 1_fas fa-sync-alt'))

WebUI.setText(findTestObject('Object Repository/Page_Shopping Cart/input_Product 1_quantity31921'), '12')

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart/button_Product 1_btn btn-primary'))
