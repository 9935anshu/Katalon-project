...
WebUI.click(findTestObject('Object Repository/Page_My Account/a_Modify your wish list'))

WebUI.click(findTestObject('Object Repository/Page_My Wish List/i_194.00_fas fa-cart-plus'))
