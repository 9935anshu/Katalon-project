...
WebUI.click(findTestObject('Object Repository/Page_My Account/a_View your order history'))

WebUI.click(findTestObject('Object Repository/Page_Order History/a_Continue'))
