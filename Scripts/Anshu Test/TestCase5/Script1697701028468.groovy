...
WebUI.setText(findTestObject('Object Repository/Page_My Account Information/input_Last Name_lastname'), 'Parihar')

WebUI.click(findTestObject('Object Repository/Page_My Account Information/h1_My Account Information'))

WebUI.click(findTestObject('Object Repository/Page_My Account Information/input_Back_btn btn-primary'))
